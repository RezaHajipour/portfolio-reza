...
function Projects({ imageUrl, title, description, stack, webpage, github }) {
    const Works = [
        ...
        },
        {
            ...
            description:
                "an App to connect Film and TV Crew. In this App users can either register themselves as a crew either search for a crew for their project. The search can be done by title, category or location.",
            stack: "html, css, JavaScript",
